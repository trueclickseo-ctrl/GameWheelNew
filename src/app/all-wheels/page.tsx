...
export const metadata = {
  title: "All Random Wheels & Decision Spinners | GameWheelClub",
  description: "Browse our complete directory of random decision wheels, picker tools, game randomizers, and generator templates on GameWheelClub.",
};
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full py-12 px-6">
        <section className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-black font-display tracking-tight text-retro-navy dark:text-cream mb-4">
            All Random Wheels Directory
          </h1>
          <p className="text-lg font-medium opacity-90 max-w-2xl mx-auto">
            Browse all our pre-built decision wheels, sports draft pickers, fandom randomizers, party games, and generator utilities.
          </p>
        </section>
