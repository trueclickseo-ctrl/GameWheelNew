...
export const metadata = {
  title: "Song Association Wheel | GameWheelClub",
  description: "Spin a keyword and try to sing a song containing that word in 10 seconds.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/party-games/song-association/",
  },
};
