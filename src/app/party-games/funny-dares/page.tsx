...
export const metadata = {
  title: "Funny Dares Wheel | GameWheelClub",
  description: "Get goofy, simple, and funny physical challenge dares.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/party-games/funny-dares/",
  },
};
