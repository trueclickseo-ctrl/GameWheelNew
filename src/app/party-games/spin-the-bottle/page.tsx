...
export const metadata = {
  title: "Spin the Bottle Wheel | GameWheelClub",
  description: "A virtual spinner replacing physical bottle setups for classic games.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/party-games/spin-the-bottle/",
  },
};
