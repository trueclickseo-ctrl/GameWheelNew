...
export const metadata = {
  title: "Things to Do When Bored Wheel | GameWheelClub",
  description: "Spin to cure boredom with productive, creative, and physical activity prompts.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/party-games/things-to-do-when-bored/",
  },
};
