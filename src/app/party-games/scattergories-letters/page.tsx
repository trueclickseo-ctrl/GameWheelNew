...
export const metadata = {
  title: "Scattergories Letters Wheel | GameWheelClub",
  description: "Spin to select a random letter for Scattergories and vocabulary games.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/party-games/scattergories-letters/",
  },
};
