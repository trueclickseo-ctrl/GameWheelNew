...
export const metadata = {
  title: "Rainbow Six Operators Wheel | GameWheelClub",
  description: "Spin to choose a random Attack or Defense operator in Siege.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/video-game-wheels/rainbow-six-operators/",
  },
};
