...
export const metadata = {
  title: "Fortnite Challenges Wheel | GameWheelClub",
  description: "Spin to get a fun challenge to complete during your next battle royale match.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/video-game-wheels/fortnite-challenges/",
  },
};
