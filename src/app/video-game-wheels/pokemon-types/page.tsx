...
export const metadata = {
  title: "Pokemon Types Wheel | GameWheelClub",
  description: "Spin to select a random Pokémon type. Perfect for monotype challenge runs.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/video-game-wheels/pokemon-types/",
  },
};
