...
export const metadata = {
  title: "Starter Pokemon Wheel | GameWheelClub",
  description: "Pick a random starter Pokémon from Gen 1 to Gen 9 for your next challenge run.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/video-game-wheels/starter-pokemon/",
  },
};
