...
export const metadata = {
  title: "Roblox Games Wheel | GameWheelClub",
  description: "Spin to choose a fun Roblox game to play when you are bored.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/video-game-wheels/roblox-games/",
  },
};
