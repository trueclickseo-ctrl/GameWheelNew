...
export const metadata = {
  title: "US States Wheel | GameWheelClub",
  description: "Spin to choose from the 50 states of America randomly.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/geography-wheels/us-states/",
  },
};
