...
export const metadata = {
  title: "Alphabet Wheel Spinner | GameWheelClub",
  description: "Spin to select a random letter from A to Z.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/generators/alphabet-wheel/",
  },
};
