...
export const metadata = {
  title: "Color Wheel Spinner | GameWheelClub",
  description: "Spin to select a random color hex code for designs or choices.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/generators/color-wheel/",
  },
};
