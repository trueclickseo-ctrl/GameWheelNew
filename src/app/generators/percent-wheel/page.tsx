...
export const metadata = {
  title: "Percent Wheel Spinner | GameWheelClub",
  description: "Spin to get a random percentage value between 10% and 100%.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/generators/percent-wheel/",
  },
};
