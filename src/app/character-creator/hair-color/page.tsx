...
export const metadata = {
  title: "Hair Color Wheel | GameWheelClub",
  description: "Spin to pick a random hair dye or OC hair color. Preloaded with natural tones and vibrant neon dyes.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/character-creator/hair-color/",
  },
};
