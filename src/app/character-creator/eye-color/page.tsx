...
export const metadata = {
  title: "Eye Color Wheel | GameWheelClub",
  description: "Decide eye shades and fantasy iris styles for your OC instantly.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/character-creator/eye-color/",
  },
};
