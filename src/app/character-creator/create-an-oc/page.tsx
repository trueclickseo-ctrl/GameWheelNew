...
export const metadata = {
  title: "Create an OC Wheel | GameWheelClub",
  description: "Spin this wheel to generate a random background, race, or class for your next original character.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/character-creator/create-an-oc/",
  },
};
