...
export const metadata = {
  title: "Age Spinner Wheel | GameWheelClub",
  description: "Randomly choose character ages and development stages.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/character-creator/age-spinner/",
  },
};
