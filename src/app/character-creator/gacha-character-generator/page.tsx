...
export const metadata = {
  title: "Gacha Character Generator Wheel | GameWheelClub",
  description: "Spin for styling themes, aesthetics, and fashion concepts to build your next Gacha Life or Gacha Club character.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/character-creator/gacha-character-generator/",
  },
};
