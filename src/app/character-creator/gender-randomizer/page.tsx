...
export const metadata = {
  title: "Gender Randomizer Wheel | GameWheelClub",
  description: "Randomize pronouns, gender identities, and presentation styles.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/character-creator/gender-randomizer/",
  },
};
