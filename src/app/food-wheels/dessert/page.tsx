...
export const metadata = {
  title: "Dessert Wheel | GameWheelClub",
  description: "Spin for a sweet treat idea. Covers cakes, pies, and baked cookies.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/food-wheels/dessert/",
  },
};
