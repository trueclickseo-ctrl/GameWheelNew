...
export const metadata = {
  title: "Fast Food Restaurants Wheel | GameWheelClub",
  description: "Spin to pick between popular fast-food chains for a quick lunch.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/food-wheels/fast-food-restaurants/",
  },
};
