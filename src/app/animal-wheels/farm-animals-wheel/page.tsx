...
export const metadata = {
  title: "Farm Animals Wheel | GameWheelClub",
  description: "Spin to pick typical barnyard and farm animals. Excellent for toddler learning.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/animal-wheels/farm-animals-wheel/",
  },
};
