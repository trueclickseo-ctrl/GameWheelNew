...
export const metadata = {
  title: "TBR Prompts Wheel | GameWheelClub",
  description: "Select your next book reading choice using To-Be-Read (TBR) prompts.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/creative-wheels/tbr-prompts/",
  },
};
