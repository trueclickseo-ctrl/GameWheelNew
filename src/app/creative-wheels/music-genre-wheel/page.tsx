...
export const metadata = {
  title: "Music Genre Wheel | GameWheelClub",
  description: "Spin to pick what music style to play or research.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/creative-wheels/music-genre-wheel/",
  },
};
