...
export const metadata = {
  title: "Movie Picker Wheel | GameWheelClub",
  description: "Resolve what to watch tonight by spinning movie genres.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/creative-wheels/movie-picker/",
  },
};
