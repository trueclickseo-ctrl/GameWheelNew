...
export const metadata = {
  title: "Arrow Spin Wheel | GameWheelClub",
  description: "Spin a compass pointer to pick a random cardinal or ordinal direction.",
  alternates: {
    canonical: "https://www.gamewheelclub.com/creative-wheels/arrow-spin/",
  },
};
